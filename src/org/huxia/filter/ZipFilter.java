...
public class ZipFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws ServletException, IOException {
        ...
        if (byteArrayOutputStream.length > 0) {
        	System.out.println("18 : 使用Filter增加内容传输功能——>byteArrayOutputStream流长度 =  " + byteArrayOutputStream.length + "byte");
            System.out.println("18:使用Filter增加网页内容压缩传输功能——>压缩后beWriting流长度=" + beWriting.length + "byte");
        }
